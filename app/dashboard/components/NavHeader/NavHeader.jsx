...
const NavHeader = () => {
  ...
  return (
    <div className="border border-white w-full px-4 py-4 flex items-center justify-between mb-5">
      <div>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            className="ml-4 cursor-pointer rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/25 hover:opacity-90 transition focus:outline-none"
            size="icon"
