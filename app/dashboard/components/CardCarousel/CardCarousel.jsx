...
export default async function CardCarousel({ userIdOrEmail, walletId = "0xABC123...DEF456" }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto relative">
      ...
      <div className="relative rounded-xl p-2 bg-linear-to-r from-primary via-indigo-500 to-primary">

        {/* <div className="p-4 rounded-xl bg-card/80 backdrop-blur-2xl relative overflow-hidden shadow-2xl shadow-black/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-primary/30"> */}
        <div className="p-4 rounded-xl bg-card/80 backdrop-blur-2xl relative overflow-hidden shadow-2xl shadow-black/30 transition-all duration-500">
          ...
          <div className="absolute top-6 right-6 flex items-center gap-2 text-xs sm:text-sm bg-white/5 text-green-500 px-4 py-1.5 rounded-full border border-primary/20 backdrop-blur-md shadow-md">
            <BadgeCheck size={16} />
           <span className="hidden font-semibold">Verified</span>
          </div>
          ...
          <div className="p-1">
            ...
            <div className="relative mb-10">
              <div className="absolute -inset-4 bg-linear-to-r from-primary/10 via-indigo-500/10 to-primary/10 blur-xl opacity-70 rounded-2xl" />
